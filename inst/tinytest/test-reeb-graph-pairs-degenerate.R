...
for (alg in c("single_pass", "multi_pass")) {
  ...
  expect_equal(p$lo_index, 0L)
  expect_equal(p$hi_index, 2L)
  ...
  expect_equal(p$lo_index, c(0L, 0L))
  expect_equal(sort(p$hi_index), c(1L, 2L))
  ...
  expect_equal(sort(p$lo_index), c(0L, 1L))
  expect_equal(p$hi_index, c(2L, 2L))
  ...
  expect_equal(p_$lo_index, c(0L, 1L, 2L))
  expect_equal(p_$hi_index, c(4L, 2L, 3L))
  ...
  expect_equal(p_$lo_index, c(0L, 1L, 2L))
  expect_equal(p_$hi_index, c(4L, 3L, 3L))
  ...
  expect_equal(p_$lo_index, c(0L, 1L, 2L, 3L))
  expect_equal(p_$hi_index, c(5L, 3L, 3L, 4L))
  ...
  expect_equal(p_$lo_index, c(0L, 2L, 3L))
  expect_equal(p_$hi_index, c(1L, 5L, 4L))
  # computed separately
